...
public class Item {
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("$14", "$270", "Phone Sensor", "Collects Phone sensor data", 3, "TODAY", "05:10 PM"));
        items.add(new Item("$23", "$116", "AutoSense", "Collects ECG & respiration data", 10, "TODAY", "11:10 AM"));
        items.add(new Item("$63", "$350", "MotionSense", "Collects motionsense data", 0, "TODAY", "07:11 PM"));
        items.add(new Item("$19", "$150", "Self Report", "Self report", 8, "TODAY", "4:15 AM"));
